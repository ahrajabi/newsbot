...
def bot_help(bot, msg, user):
    ...
    menu = [
        ...
        ('/contact', 'تماس با ما', 'راه‌های ارتباطی تیم خبرِمن - انتقادات، پیشنهادات، معرفی کانال تلگرام و ...')
    ]
    ...
    text = '🔍' + 'راهنما' + '\n\n'
    text += '''🖋 روبات خبرِمن تمام کانال‌های بورس و رسانه‌های اقتصادی را دنبال می‌کند و آن‌چه به 🎯 نماد‌های شما مرتبط باشد را برای شما پالایش می‌کند.


📉سایت رسمی کدال
📊بیش از ۱۰۰ کانال معتبر بورسی
📈سایت‌های خبری رسمی
